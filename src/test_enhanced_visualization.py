...
def main():
    """Run enhanced SUMO traffic visualization test"""
    # Parse command line arguments
    parser = argparse.ArgumentParser(description='Run enhanced SUMO traffic visualization')
    ...
    parser.add_argument('--scenario', type=str, default=None,
                        help='Specific scenario file to use (without .sumocfg extension)')
